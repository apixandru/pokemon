 ...
 * @since Jun 22, 2016
 */
public class GdxPlayerSpriteProvider implements PlayerSpriteProvider<TextureRegion, Animation> {
    ...
    @Override
    public Animation getMoving(Constants.MoveDirection moveDirection) {
